...
export const mainInformation = {
  ...
  summary: LocaleStringBuilder
    .create("Minha apresentação")
    ...
    .en("With more than 10 years of experience in development, I've been working on many systems, such as, Banking systems, Big Data analysis platforms from multiple sources, websites, mobile apps and games. My main focus is on the quality of the delivery, and I use always market-proof best practices.")
    .build(),
